...
git config --global user.email "nuha.khan4@gmail.com"
git config --global user.name "Nuha4"
...
git remote set-url origin https://github.com/Nuha4/generic-dashboard
############
# Step: 07 #
############
...
git push --all -f https://github.com/Nuha4/generic-dashboard